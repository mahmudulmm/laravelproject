            ...
            <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              <h6>Today</h6>
                              <h5>$<span class="counter">25698</span><span class="font-danger">-36%($2658)</span></h5><span class="font-roboto"> Than yesterday</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              <h6>Month</h6>
                              <h5>$<span class="counter">6954</span><span class="font-danger">-15%($369) </span></h5><span class="font-roboto"> Than last month</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              <h6>New Order</h6>
                              <h5>6981<span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 68%</span></h5>
                              <div class="icon-bg">
                      ...
                      <div class="col-sm-6">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              <h6>Pending  Order</h6>
                              <h5>783<span class="font-roboto font-danger f-w-700"><i class="icofont icofont-arrow-down"></i> 12%</span></h5>
                            </div>
                          </div>
                          <div class="icon-bg">
                        ...
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              ...
                              <h5>69<span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 20%</span></h5>
                            </div>
                          </div>
                          <div class="icon-bg">
                    ...
                    <div class="card-body">
                      <div class="activity-media">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <h6 class="font-roboto">Any desktop publishing pack ages editors.</h6><span><i class="me-2" data-feather="clock"></i><span class="font-roboto">25 July 2017 | 20 hours ago</span></span>
                          </div>
                        </div>
                        <div class="media">
                          <div class="recent-circle bg-primary"></div>
                          <div class="media-body">
                            <h6 class="font-roboto">
                              ...
                              is not simply.
                            </h6><span><i class="me-2" data-feather="clock"></i><span class="font-roboto">25 July 2017 | 20 hours ago</span></span>
                          </div>
                        </div>
                        <div class="media">
                          <div class="recent-circle bg-primary"></div>
                          <div class="media-body">
                            <h6 class="font-roboto">Established fact that a reader will be distracted lorem.</h6><span><i class="me-2" data-feather="clock"></i><span class="font-roboto">25 July 2017 | 20 hours ago</span></span>
                          </div>
                        </div>
                        <div class="media">
                          <div class="recent-circle bg-primary"></div>
              ...
              <div class="col-xl-4 col-md-6 box-col-6 lg-50">
                <div class="card custom-profile">
                  <div class="pb-0">
                    <div class="card-profile"><img class="user-img" src="{{asset('/dashboard_assets')}}/images/other-images/user-profile.png" alt=""></div>
                    <div class="text-center profile-details">
                      <h4>James Martin</h4>
                      <h6>Manager</h6>
                    </div>
                    <ul class="card-social">
                      <li><a class="social-link" href="https://accounts.google.com/"><img class="user-img" src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/1.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://www.facebook.com/"><img class="user-img" src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/2.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://twitter.com/"><img class="user-img" src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/3.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://www.instagram.com/"><img class="user-img" src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/4.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://dashboard.rss.com/auth/sign-in/"><img class="user-img" src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/5.svg" alt=""></a></li>
                    </ul>
                  </div>
              ...
              <div class="col-xl-4 box-col-6 lg-100">
                <div class="row">
                  <div class="col-xl-12 col-lg-6 box-col-6 lg-50">
                    <div class="card testimonial">
                      <div class="card-body">                      <img class="img-90 user-img" src="{{asset('/dashboard_assets')}}/images/user/user-dp.png" alt="">
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/2.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Facebook</h4>
                      </div>
                    </div>
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/3.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Twitter</h4>
                      </div>
                    </div>
                  ...
                  <div class="card-footer">
                    <div class="row">
                      ...
                      <div class="col text-center">
                        <h6 class="font-roboto">Likes</h6>
                        <h5 class="mb-0 font-roboto font-primary mt-1"> <span class="counter">4</span>k</h5>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/6.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Linkedin</h4>
                      </div>
                    </div>
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="http://admin.pixelstrap.com/zeta/assets/images/svg-icon/4.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Instagram</h4>
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="table-responsive mb-0">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td><img src="{{asset('/dashboard_assets')}}/images/dashboard/chrome.png" alt=""></td>
                            <td>Google Chrome</td>
                            <td>28%</td>
                            <td>76%</td>
                            <td>36%</td>
                          ...
                          <tr>
                            <td><img src="{{asset('/dashboard_assets')}}/images/dashboard/firefox.png" alt=""></td>
                          ...
                          <tr>
                            <td><img src="{{asset('/dashboard_assets')}}/images/dashboard/safari.png" alt=""></td>
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordernone">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="media">                             <img src="{{asset('/dashboard_assets')}}/images/user/4.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-radius align-top m-r-15 rounded-circle" src="{{asset('/dashboard_assets')}}/images/user/1.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-radius align-top m-r-15 rounded-circle" src="{{asset('/dashboard_assets')}}/images/user/5.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img src="{{asset('/dashboard_assets')}}/images/user/6.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img src="{{asset('/dashboard_assets')}}/images/user/7.jpg" alt="">
                                <div class="media-body">
