...
<div class="header-wrapper row m-0">
  <div class="header-logo-wrapper col-auto p-0">
    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{asset('/dashboard_assets')}}/images/logo/logo.png" alt=""></a></div>
      ...
      <li class="cart-nav onhover-dropdown">
        ...
        <div class="cart-dropdown onhover-show-div">
          ...
          <ul class="custom-scrollbar">
            <li>
              <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{asset('/dashboard_assets')}}/images/banner-1.jpg" alt="">
            ...
            <li>
              <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{asset('/dashboard_assets')}}/images/product-4.png" alt="">
                <div class="media-body">
            ...
            <li>
              <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{asset('/dashboard_assets')}}/images/product-6.jpg" alt="">
                <div class="media-body">
      ...
      <li class="onhover-dropdown">
        ...
        <div class="onhover-show-div notification-dropdown">
          ...
          <ul class="custom-scrollbar">
            <li>
              <div class="media">
                <div class="notification-img bg-light-primary"><img src="{{asset('/dashboard_assets')}}/images/avtar/man.png" alt=""></div>
                <div class="media-body">
            ...
            <li>
              <div class="media">
                <div class="notification-img bg-light-secondary"><img src="{{asset('/dashboard_assets')}}/images/avtar/teacher.png" alt=""></div>
                <div class="media-body">
            ...
            <li>
              <div class="media">
                <div class="notification-img bg-light-info"><img src="{{asset('/dashboard_assets')}}/images/avtar/teenager.png" alt=""></div>
                <div class="media-body">
            ...
            <li>
              <div class="media">
                <div class="notification-img bg-light-success"><img src="{{asset('/dashboard_assets')}}/images/avtar/chinese.png" alt=""></div>
                <div class="media-body">
